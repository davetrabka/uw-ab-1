...
async function seed() {
  ...
  await Promise.all([
    ...
    Review.create({
      author: 'Tom',
      date: 'November 2016',
      review: `The house was exactly as described! You can really feel how the host took pride in their rental and honestly wanted to make sure we had a great experience. If I could give our host 10 stars for communication, I would! His response time was incredibly fast! Our host welcomed us with a very thoughtful gift and there were complete instructions for checking in as well as checking out. We found the town to be very charming and hit a home run with a few local restaurants. I've rented many homes across the country and this one has to be one of the best values I've seen. I would highly recommend this house and the host to anyone. Tom`,
    }),
    Review.create({
      author: 'Jennifer',
      date: 'November 2016',
